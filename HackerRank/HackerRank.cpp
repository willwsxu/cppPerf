...
TEST_CASE("Hacker rank Greedy toys shipping", "[NEW]")
{
...
TEST_CASE("Hacker rank Greedy Beautiful Pairs", "[NEW]")
{
...
TEST_CASE("Hacker rank sort closest pair", "[NEW]")
{
	CHECK(closestNumbers(vector<int>{-5, 15, 25, 71, 63}) == vector<int>{63, 71});
}

TEST_CASE("sorted vector", "[NEW]")
{
